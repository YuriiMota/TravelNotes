    ...
    <form action="/create" method="post" enctype="multipart/form-data">
        ...
        <div class="container" style="padding: 10px;">
            <button class="btn btn-default" type="Submit" value="Submit"
                    style="height: 48px;padding: 10px;margin: 39px;background-color: rgb(82,129,176);font-size: 15px;color: rgb(255,255,255);opacity: 0.82;width: 181px;font-family: Bitter, serif;">
                Submit
            </button>
            <button class="btn btn-default"
                    type="button" onclick="location.href = '/mynotes';"
