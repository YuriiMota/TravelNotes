        ...
        <div class="container hero">
            <div class="row" style="height: 481px;">
                <div class="col-md-8 col-md-offset-2" style="height: 429px;">
                    ...
                    <h1 style="margin: 24px;height: 42px;width: 736px;">First Name</h1><input type="text" value="${user.getFirstName()}"  name="fname"style="width: 239px;height: 37px;margin: -1px;">
                    <h1 style="margin: 14px;height: 42px;width: 736px;">Last Name</h1><input type="text" value="${user.getLastName()}"  name="lname"style="width: 239px;height: 37px;padding: 0px;">
                    <button class="btn btn-default" type="Submit" style="margin: 24px;height: 37px;width: 69px;background-color: rgb(4,179,0);color: rgb(234,234,234);">Save</button>
                    <button
                        class="btn btn-default" type="button" onclick="location.href = '/mynotes';" style="margin: 24px;background-color: rgb(235,71,71);color: rgb(235,235,235);">Cancel</button>
                </div>
            </div>
        </div>
            </form>
